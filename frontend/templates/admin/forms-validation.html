...
<!-- Mirrored from www.okler.net/previews/porto-admin/4.3.0/forms-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Mar 2025 09:40:29 GMT -->
<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>Form Validation | Porto Admin - Responsive HTML5 Template</title>
	...
	<body>
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="https://www.okler.net/previews/porto-admin/4.3.0" class="logo">						<img src="img/logo.png" width="75" height="35" alt="Porto Admin" />
					</a>
				...
				<div class="header-right">
					<form action="https://www.okler.net/previews/porto-admin/4.3.0/pages-search-results.html" class="search nav-form">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body card-margin">
					...
					<div class="row">
						<div class="col-lg-6">
							<form id="form" action="https://www.okler.net/previews/porto-admin/4.3.0/forms-validation.html" class="form-horizontal">
								<section class="card">
									...
									<div class="card-body">
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">Full Name <span class="required">*</span></label>
											<div class="col-sm-9">
										...
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">GitHub</label>
											<div class="col-sm-9">
												<input type="url" name="github" class="form-control" placeholder="eg.: https://github.com/johndoe" />
											</div>
										</div>
										<div class="form-group row pb-2">
											<label class="col-sm-3 control-label text-sm-end pt-2">Skills <span class="required">*</span></label>
											<div class="col-sm-9">
						...
						<!-- col-lg-6 -->
						<div class="col-lg-6">
							<form id="chk-radios-form" action="https://www.okler.net/previews/porto-admin/4.3.0/forms-validation.html">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										...
										<h2 class="card-title">Validating Checkbox and Radios</h2>
										<p class="card-subtitle">
									...
									<div class="card-body">
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">Porto Admin is <span class="required">*</span></label>
											<div class="col-sm-9">
										...
										<div class="form-group row pb-2">
											<label class="col-sm-3 control-label text-sm-end pt-2">I will use it for <span class="required">*</span></label>
											<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-lg-6">
							<form id="summary-form" action="https://www.okler.net/previews/porto-admin/4.3.0/forms-validation.html" class="form-horizontal">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
									...
									<div class="card-body">
										...
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">Resume <span class="required">*</span></label>
											<div class="col-sm-9">
						...
						<div class="col-lg-6">
							<form id="selects-form" action="https://www.okler.net/previews/porto-admin/4.3.0/forms-validation.html">
								<section class="card">
									<header class="card-header">
										<div class="card-actions">
											<a href="#" class="card-action card-action-toggle" data-card-toggle></a>
										...
										<h2 class="card-title">Validation Selects</h2>
										<p class="card-subtitle">
									...
									<div class="card-body">
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">Company</label>
											<div class="col-sm-9">
										...
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">Browsers</label>
											<div class="col-sm-9">
										...
										<div class="form-group row pb-3">
											<label class="col-sm-3 control-label text-sm-end pt-2">State</label>
											<div class="col-sm-9">
												<select id="states" name="states" data-plugin-selectTwo class="form-control populate" title="Please select at least one state" required>
		...
		<script src="vendor/jquery-validation/jquery.validate.js"></script>		<script src="vendor/select2/js/select2.js"></script>
